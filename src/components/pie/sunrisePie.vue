<template>
  <div class="chart-content">
    ...
    <div class="chart-box" ref="sunrisePie" :style="{ 'background-color': themeType == 1 ? '#07124a' : '#fff' }"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    initChart() {
      let that = this,
        sunrisePie = that.$echarts.init(that.$refs.sunrisePie),
        dataList = [
          {
            name: "经",
            itemStyle: {
      ...
      sunrisePie.setOption(option, true);
    },
  },
  components: { navBar },
};
