...
export default {
  ...
  data() {
    return {
      optionString: {},
      tipTitle: '注：请注意该图表使用的是highcharts，可以在src/components/pie/3dAnnularPie.vue中找到直接使用。'
    };
  },
  mounted() {
    this.initChart();
      ...
      var option = {
        ...
        plotOptions: {
          pie: {
            ...
            //   formatter: function () {
            //     return (
            //       '<span style="display:block;width:7px;height:7px;background-color:' + this.color + '"></span>' + this.key + this.y
            //     );
            //   },
            //   style: {
            //     color: "#333",
