<template>
  <div class="main-content">
    <v-head :color="color" :themeColor="themeColor" :porpThemeType="themeType" @themeChoose="themeChoose"></v-head>
    <div class="inner flex-box" :style="{'background-color': themeColor[themeType]}">
      <v-nav :backgroundColor="themeColor[themeType]" :navListColor="navListColor[themeType]" :themeType="themeType" :menuList="menuList"></v-nav>
  ...
  data() {
    return {
      ...
      menuList: [
        {
          title: "柱状图",
          iconCls: "iconfont iconzhuzhuangtu",
          Vrouter: "barCharts",
          secondList: [
            {
              name: "来访大厅",
