  ...
  <div class="one-content-charts-content content flex-box">
    <div class="left-box" ref="leftBox">
      ...
      <div class="content-box flex-box">
        ...
        <div class="pie-box" :style="{ 'height': '1040px','border-color': themeType == 1 ? '#082b7d' : '#eaeaea'}">
          <VerticalHeat></VerticalHeat>
        </div>
        <div class="pie-box" :style="{'width': '66.15%','margin-top': '-520px','border-color': themeType == 1 ? '#082b7d' : '#eaeaea'}">
          <HeatTwo></HeatTwo>
        </div>
      </div>
    </div>
...
.content .left-box .content-box:last-child .pie-box {
    margin-bottom: 0;
}
</style>
